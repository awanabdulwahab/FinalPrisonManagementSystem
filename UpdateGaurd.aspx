<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMasterPage.Master" AutoEventWireup="true" CodeBehind="UpdateGaurd.aspx.cs" Inherits="PrisonManagementSystem.UpdateGaurd" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container">
        <div class="form-horizontal">
            <h2>Update Gaurd Information</h2>
            <hr />
            <div class="form-group">
                <asp:Label ID="Label3" runat="server" CssClass="col-md-2 control-label" Text="Gaurd ID"></asp:Label>
                <div class="col-md-7">
                    <asp:TextBox ID="txtGaurdId" CssClass="form-control" runat="server"></asp:TextBox> <asp:Button ID="btnShow" runat="server" Text="Show information" CssClass="btn btn-default" OnClick="btnShow_Click"/>
                    <asp:RequiredFieldValidator ID="IDFieldValidator" CssClass="text-danger" runat="server" ErrorMessage="This field is Required !" ControlToValidate="txtGaurdId"></asp:RequiredFieldValidator>
