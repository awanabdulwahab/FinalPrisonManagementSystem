<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMasterPage.Master" AutoEventWireup="true" CodeBehind="UpdateAdmin.aspx.cs" Inherits="PrisonManagementSystem.UpdateAdmin" %>
    ...
    <div class="container">
        <div class="form-horizontal">
            ...
            <div class="form-group">
                ...
                <div class="col-md-7">
                    <asp:TextBox ID="txtAdminId" CssClass="form-control" runat="server"></asp:TextBox><asp:Button ID="btnShow" runat="server" Text="Show information" CssClass="btn btn-default" OnClick="btnShow_Click"/>
                    <asp:RequiredFieldValidator ID="IDFieldValidator" CssClass="text-danger" runat="server" ErrorMessage="This field is Required !" ControlToValidate="txtAdminId"></asp:RequiredFieldValidator>
