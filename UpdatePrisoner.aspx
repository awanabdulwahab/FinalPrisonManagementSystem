<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMasterPage.Master" AutoEventWireup="true" CodeBehind="UpdatePrisoner.aspx.cs" Inherits="PrisonManagementSystem.UpdatePrisoner" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container">
        <div class="form-horizontal">
            <h2>Update Prisoner Information</h2>
            <hr />
            <div class="form-group">
                <asp:Label ID="Label3" runat="server" CssClass="col-md-2 control-label" Text="Prisoner ID "></asp:Label>
                <div class="col-md-7">
                    <asp:TextBox ID="txtPrisonerId" CssClass="form-control" runat="server"></asp:TextBox><asp:Button ID="btnShow" runat="server" Text="Show information" CssClass="btn btn-default" OnClick="btnShow_Click"/>
                    <asp:RequiredFieldValidator ID="IDFieldValidator" CssClass="text-danger" runat="server" ErrorMessage="This field is Required !" ControlToValidate="txtPrisonerId"></asp:RequiredFieldValidator>
